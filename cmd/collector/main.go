...
import (
	...
	pb "net-telemetry-service/proto" // ВНИМАНИЕ: Проверь, что имя модуля в go.mod совпадает с "net-telemetry-service"
)
...
// GetDeviceState вытягивает быстрый слепок из Redis
...
// GetDeviceHistory вытягивает аналитическую историю из Postgres
func (s *server) GetDeviceHistory(ctx context.Context, req *pb.DeviceRequest) (*pb.DeviceHistoryResponse, error) {
	...
	// Запрашиваем последние 10 записей телеметрии
